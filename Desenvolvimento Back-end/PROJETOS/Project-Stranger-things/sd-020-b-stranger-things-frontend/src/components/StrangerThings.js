...
const strangerThingsConfig = {
  url: process.env.REACT_APP_HAWKINS_URL || 'https://caique-up.herokuapp.com/',
  timeout: process.env.REACT_APP_HAWKINS_TIMEOUT || TIMEOUT_LIMIT,
};
const upsideDownConfig = {
  url: process.env.REACT_APP_UPSIDEDOWN_URL || 'https://caique-dw.herokuapp.com/',
  timeout: process.env.REACT_APP_UPSIDEDOWN_TIMEOUT || TIMEOUT_LIMIT,
};
