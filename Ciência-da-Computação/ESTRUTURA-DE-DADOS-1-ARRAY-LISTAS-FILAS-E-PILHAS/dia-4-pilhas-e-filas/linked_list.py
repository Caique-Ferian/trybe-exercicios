...
class LinkedList:
    ...
    def index_of(self, value):
        position = 1
        value_to_return = self.head_value
        while value_to_return:
            if value_to_return == value:
                return value_to_return
            value_to_return = value_to_return.next
            position += 1
        return -1
...
if __name__ == "__main__":
    ...
    print(linked_list)  # saída: LinkedList
    # (len=2 value=Node(value=2 next=Node(value=1 next=None)))

    linked_list.insert_last(3)
    print(linked_list)  # saída: LinkedList
    # (len=3 value=Node(value=2 next=Node(value=1
    # next=Node(value=3 next=None))))

    linked_list.remove_last()
    print(linked_list)  # saída:
